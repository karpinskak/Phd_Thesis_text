...
\noindent The maximal strain parameter $A_{max}$ (minimal circulation $\Gamma_{min}$) increases (decreases) weakly with $P$. So the larger the vortex core size $\delta$ and gravity influence $g sin\theta$ the larger the minimal circulation needed
